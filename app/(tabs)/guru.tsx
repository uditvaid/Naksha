...
const styles = StyleSheet.create({
  ...
  questionCount: { backgroundColor: Colors.goldDim, borderRadius: Radius.full, paddingHorizontal: 10, paddingVertical: 5 },
  questionCountText: { fontSize: 10, fontFamily: Fonts.cinzel, color: Colors.gold, lineHeight: 14, includeFontPadding: false },
